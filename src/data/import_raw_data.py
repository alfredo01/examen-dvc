...
def main(raw_data_relative_path="./data/raw", 
        filenames = ["raw.csv"],
        source_url= "https://datascientest-mlops.s3.eu-west-1.amazonaws.com/mlops_dvc_fr/raw.csv"          
        ):
    """ Upload data from source_link in ./data/raw
    """
    import_raw_data(raw_data_relative_path, filenames, source_url)
